...
class Planet:
    ...
    __slots__ = ("x","y","harvestable_resource","worker_groups","resources","building",)
    ...
    def __init__(self, x: int, y: int, harvestable_resource: Optional[Resource], worker_groups: List[WorkerGroup], resources: Dict[Resource, int], building: Optional[Building]):
        self.x = x
        """TODO - Document"""
        self.y = y
        """TODO - Document"""
    ...
    def read_from(stream: StreamWrapper) -> "Planet":
        ...
        if stream.read_bool():
            ...
            building = None
        return Planet(x, y, harvestable_resource, worker_groups, resources, building)
