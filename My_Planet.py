...
class MyPlanet:
    def __init__(self, planet: Planet, idx: int, my_index: int):
        self.building: Building = planet.building
        self.idx = idx
        self.planet = planet
        ...
        if self.harvestable_resource == Resource.STONE: self.mission = 'stone'
        elif self.harvestable_resource == Resource.ORE: self.mission = 'ore'
        elif self.harvestable_resource == Resource.SAND: self.mission = 'sand'
        elif self.harvestable_resource == Resource.ORGANICS: self.mission = 'organics'
        else: self.mission = 'free'
